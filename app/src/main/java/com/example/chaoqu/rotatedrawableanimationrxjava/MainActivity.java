package com.example.chaoqu.rotatedrawableanimationrxjava;
...
public class MainActivity extends Activity implements View.OnClickListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener{
     ...
     * 动画状态
     */
    private AnimatorState state = AnimatorState.State_Stop;
    /**
     * 音乐播放器状态
     */
    ...
    private void initAllViews() {
        ...
        cane = (ImageView) findViewById(android.R.id.background);
    ...
    private void start() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                cane.getDrawable().setLevel(level);
            }
        });
    ...
    private void audioStart() {
        boolean pauseOrPrepare = audioState == AudioState.STATE_PAUSE || audioState == AudioState.STATE_PREPARE;
        if(mediaPlayer != null && (pauseOrPrepare)) {
